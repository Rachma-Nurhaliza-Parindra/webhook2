...
func PostBalasan(w http.ResponseWriter, r *http.Request) {
	...
	link := "https://medium.com/@rachmanurhalizastudent/whatsauth-free-2fa-otp-notif-whatsapp-gateway-api-gratis-e318037b0f54"
	if r.Header.Get("Secret") == os.Getenv("SECRET") {
		if msg.Message == "loc" || msg.Message == "Loc" || msg.Message == "lokasi" || msg.LiveLoc {
			...
			dt := &wa.TextMessage{
				To:       msg.Phone_number,
				IsGroup:  false,
				Messages: "Hai Guys" + msg.Alias_name + ".\nAku rachma, salam kenal yaaa. \nTapi, Rachmanya lagi ga adaaa :( \nCara penggunaan WhatsAuth ada di link berikut ini ya kak...\n" + link,
			}
			resp, _ = atapi.PostStructWithToken[atmessage.Response]("Token", os.Getenv("TOKEN"), dt, "https://api.wa.my.id/api/send/message/text")
		}
	} else {
